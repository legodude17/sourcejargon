...
pp.readToken_pipe_amp = function(code) { // '|&'
  return this.finishOp(code === 124 ? tt.logicalOR : tt.logicalAND, 1)
}

pp.readToken_caret = function() { // '^'
  let next = this.input.charCodeAt(this.pos + 1)
  if (next === 61) return this.finishOp(tt.assign, 2)
  return this.finishOp(tt.caret, 1)
}
...
pp.readToken_eq_excl = function(code) { // '=!'
  ...
  if (code === 33 && next === 58) return this.finishOp(tt.assign, 2)
  return this.finishOp(code === 61 ? tt.eq : tt.excl, 1)
}

pp.readToken_at = function () {
  ++this.pos
  this.skipSpace()
...
pp.getTokenFromCode = function(code) {
  ...
  case 64: return this.readToken_at()
